              ...
              <table className="table-fixed divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-800">
                  <tr>
                    <th
                      scope="col"
                      className="w-1/3 px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"
                    >
                      Name
                    </th>
                    ...
                    <th
                      scope="col"
                      className="w-5 overflow-auto px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"
                    >
                      Sectors
                    </th>

                    <th scope="col" className="w-1/3 relative py-3.5 px-4">
